...
public class DeleteUserRoleCommand : IRequest<ResponseDTO<ResponseModel>>, IAuthorizableRequest
{
    ...
    public class Handler : IRequestHandler<DeleteUserRoleCommand, ResponseDTO<ResponseModel>>
    {
        ...
        public async Task<ResponseDTO<ResponseModel>> Handle(DeleteUserRoleCommand request, CancellationToken cancellationToken)
        {
            try
            {
